...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "703bd9caab50b139428cea1aaff9974ebee5742e"
  WORKING_DIRECTORY "/home/lesha/CLionProjects/Lessons_4sem/lesson2/cmake-build-debug/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lesha/CLionProjects/Lessons_4sem/lesson2/cmake-build-debug/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lesha/CLionProjects/Lessons_4sem/lesson2/cmake-build-debug/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
